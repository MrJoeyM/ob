...
private:
    ...
    CallBackHandler stopMissionCallback;//stopmission
	...
	void mobile_data_push_info_callback(dji_sdk::TransparentTransmissionData information)
	{
		...
		mobile_new_data = 1;
		cout<<mobile_data.data[0]<<mobile_data.data[1]<<endl;
		int cmdID = (int)((char)(mobile_data.data[0])-'0')*100+(int)((char)(mobile_data.data[1])-'0')*10+(int)((char)(mobile_data.data[2])-'0');//uint32_t8
